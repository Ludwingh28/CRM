import { LogOut, Package, Smartphone, MapPin, ShoppingCart, FileText, User, ChevronLeft, Users, UserPlus } from 'lucide-react';
...
function SideBar({ currentPage, setCurrentPage }) {
  ...
  const pages = [
    ...
    { id: 'gestion-clientes', name: 'Gestión Clientes', icon: Users, active: 'bg-rose-600 text-white shadow-rose-400/40 shadow' },
    { id: 'creacion-clientes', name: 'Creación de Clientes', icon: UserPlus, active: 'bg-pink-600 text-white shadow-pink-400/40 shadow' },
