...
function App() {
  ...
  return (
    <div className="flex h-screen bg-linear-to-br from-gray-50 to-gray-100 overflow-hidden relative z-0">
      ...
      {/* Overlay para móvil */}
      {isMobileMenuOpen && <div className="md:hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-[9998] transition-all duration-300" onClick={toggleMobileMenu} />}
